...
namespace sumaDeVectoresEyM
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double gradosVec1, gradosVec2, magnitudVec1X, magnitudVec1Y, magnitudVec2X, magnitudVec2Y, componetesX1, componetesX2, componentesY1, componentesY2, sumatoriaDeLosComponentesX, sumatoriaDeLosComponentesY, resultante,gradosResultado;
            ...
            componetesX1 = Math.Cos(gradosVec1 * Math.PI / 180) * magnitudVec1X;
            Console.WriteLine("Componente del primer vector con respecto a X: {0}", componetesX1);
            componentesY1 = Math.Sin(gradosVec1 * Math.PI / 180) * magnitudVec1Y;
            ...
            componetesX2 = Math.Cos(gradosVec2 * Math.PI / 180) * magnitudVec2X;
            Console.WriteLine("Componente del primer vector con respecto a X: {0}", componetesX2);
            componentesY2 = Math.Sin(gradosVec2 * Math.PI / 180) * magnitudVec2Y;
